            ...
            <div class="d-flex justify-content-center h-100">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-12 offset-md-12 col-sm-12 px-3">
                                <div class="d-flex justify-content-center h-100">
                                    <div class="col-mb-4 col-sm-4">
                                    <a href="{{ url('/account/login') }}" class="btn float-right login_btn">Accountant</a>
                                    </div>
                                    <div class="col-mb-4 col-sm-4" > 
                                        <a href="{{ url('/fleet/login') }}" class="btn float-right login_btn">Fleets</a>
                                    </div>
                                    <div class="col-mb-4 col-sm-4">
                                    <a href="{{ url('/dispatcher/login') }}" class="btn float-right login_btn">Dispatcher</a>
                                    </div>
                                </div>
                            </div>
                        </div>
